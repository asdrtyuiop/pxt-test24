...
namespace _http {
    ...
    let _SERIAL_TX = SerialPin.P2
    let _SERIAL_RX = SerialPin.P1
    let _WIFI_SSID = ""
    let _WIFI_PASSWORD = ""
    let _IP = ""
    let cityID = ""
    ...
    */
    ...
    //% block=" setup WIFI | Pin set: | Receive data (green wire): %receive| Send data (blue wire): %send | Wi-Fi: | Name: %SSID| Password: %PASSWORD| Start connection"
